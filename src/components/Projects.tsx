  ...
  return (
    <section id="projects" className="py-20">
      <div className="container-wide">
        ...
        >
          {projects.map((p, idx) => (
            <motion.article key={`project-${idx}-${p.title}`} className="glass-card relative project-card-hover flex flex-col overflow-hidden" variants={item} whileHover={{ scale: 1.02 }}>
              ...
              <a href="#" aria-label={`Open project ${p.title}`} className="block">
                ...
                <div className="mt-3 px-3 pb-4">
                  <div className="text-white font-semibold text-lg heading-gradient">{p.title}</div>
