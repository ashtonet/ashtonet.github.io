...
const heroImageModules = import.meta.glob('/public/images/hero/*.{jpg,jpeg,png,webp,avif}', {
  eager: true,
  import: 'default',
  query: '?url',
...
const heroImages = Object.entries(heroImageModules)
  .map(([path, src]) => ({ src, label: formatHeroLabel(path), position: 'center 48%' }))
  .sort((a, b) => a.label.localeCompare(b.label))

const fallbackHeroImage = { src: '/images/hero/Honolulu.jpg', label: 'HONOLULU', position: 'center 48%' }
